...
\newcommand{\Studiengangsleitung}[1]{\def\Studiengangsleitung{#1}}
...
\newcommand{\Azubi}[1]{\def\Azubi{#1}}
\newcommand{\Unterweisungsthema}[1]{\def\Unterweisungsthema{#1}\hypersetup{pdftitle={#1}}}
