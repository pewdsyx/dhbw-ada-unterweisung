...
\AutorDerArbeit{Max Müller}
\Matrikelnummer{123456789}
\Firma{Firmenname Firmierung}
\Kurs{DHBW Kursbezeichnung}
\Studiengangsleitung{Prof. Dr.-Ing. habil. Anna Musterfrau}

\DieFachrichtungDerAusbildung{Daten- und Prozessanalyse}
\DieBerufsausbildung{Berufsausbildung zur Fachinformatikerin (m/w/d)}
\Unterweisungsthema{Cluster-Verfahren: Erarbeitung eines Verfahrens}
...
\input{chapter/2_rahmenbedingungen}
\input{chapter/3_lernziele}
\input{chapter/4_motivation}
\input{chapter/5_paedPrin}
\input{chapter/6_handlungskompetenz}
\input{chapter/7_unterweisungsplan}

%-----------------

\clearpage
\pagenumbering{Roman}
\setcounter{page}{7} %TODO: schauen, ob die Zahl passt!
